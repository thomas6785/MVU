    ...
    always_ff @ (posedge mvu_ext_if.clk) begin : always_ff_block
        ...
        if (~mvu_ext_if.rst_n) begin : reset // reset all registers to default values
            ...
            unique case (mvu_pkg::mvu_csr_t'(register_adr[11:0]))
                ...
                mvu_pkg::CSR_MVUSLENGTH_2: mvu_cfg_shadow[genvar_mvu_id].slength[1] <= apb.pwdata[BLENGTH-1 : 0];
                mvu_pkg::CSR_MVUSLENGTH_3: mvu_cfg_shadow[genvar_mvu_id].slength[1] <= apb.pwdata[BLENGTH-1 : 0];
                mvu_pkg::CSR_MVUSLENGTH_4: mvu_cfg_shadow[genvar_mvu_id].slength[1] <= apb.pwdata[BLENGTH-1 : 0];
                mvu_pkg::CSR_MVUBLENGTH_1: mvu_cfg_shadow[genvar_mvu_id].blength[1] <= apb.pwdata[BLENGTH-1 : 0];
                mvu_pkg::CSR_MVUBLENGTH_2: mvu_cfg_shadow[genvar_mvu_id].blength[1] <= apb.pwdata[BLENGTH-1 : 0];
                mvu_pkg::CSR_MVUBLENGTH_3: mvu_cfg_shadow[genvar_mvu_id].blength[1] <= apb.pwdata[BLENGTH-1 : 0];
                mvu_pkg::CSR_MVUBLENGTH_4: mvu_cfg_shadow[genvar_mvu_id].blength[1] <= apb.pwdata[BLENGTH-1 : 0];
